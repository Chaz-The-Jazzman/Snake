...
void init_jeu(TYPE_POMME* pomme, TYPE_SNAKE* snake, TYPE_SPEED_APPLE* speed_apple, TYPE_INVISIBLE_APPLE* invisible_apple, TYPE_EXPLOSIVE_APPLE* explosive_apple,TYPE_TELEPORT_APPLE* teleport_apple);
